...
whose first derivative is $U\omega \cos(\omega t)$. In {numref}`fig:Errors1stDerivative`, the error of the first derivative is shown for the forward, backward, centred and 4th order difference formulas.


```{figure} Errors_FDfirstDerivative_w4th.png
---
height: 400px
name: fig:Errors1stDerivative
---
