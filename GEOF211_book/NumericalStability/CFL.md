...
We can combine the figures showing the numerical domain of dependence for the FTBS scheme (Figure {numref}`fig:DoD`) and the exact domain of dependence from the charactheristics of the advection equation (Figure {numref}`fig:Char2`), we obtain:
